...
export default class RecipeDetails extends Component {
    /*constructor(props){
      ...
      this.state={
        recipe:recipe,
        url:`https://www.food2fork.com/api/get?key=5d29b243270eda16f2a50184b84e4fc9&rId=${this.props.id}`  
      }
        }
 ...
 async componentDidMount(){
     ...
     const url=`https://www.food2fork.com/api/get?key=5d29b243270eda16f2a50184b84e4fc9&rId=${id}`
     try{
